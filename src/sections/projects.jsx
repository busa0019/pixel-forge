...
const projects = [
  {
    ...
    cover: "/img-10.png",
    images: ["/img-12.png", "/img-29.png", "/img-11.jpg", "/img-13.jpg", "/img-15.png", "/img-14.jpg"],
  ...
  },
  {
    ...
    cover: "/img-21.jpg",
    images: ["/img-19.png", "/img-28.png", "/img-20.png", "/img-18.png", "/img-16.png"],
  ...
  },
  {
    ...
    cover: "/img-22.png",
    images: ["/img-23.png", "/img-24.png", "/img-25.png", "/img-26.png", "/img-27.png"],
  ...
  },
  {
    ...
    cover: "/img-30.jpg",
    images: ["/img-31.png", "/img-32.png", "/img-33.png", "/img-34.png", "/img-35.png", "/img-36.png", "/img-37.png", "/vid-1.mp4", "/vid-2.mp4", "/vid-3.mp4"],
...
const Project = () => {
  ...
  const handleStartSimilarProject = () => {
    ...
    const msg = `Hi PixelForge Studio, I'm interested in starting a similar project to "${selectedProject.type}" — ${selectedProject.title}. Can we discuss pricing and timeline?`;

    setSelectedProject(null);
    navigate("/contact", { state: { message: msg } });
  };
  ...
  return (
    <>
      <section
        ...
        id="projects"
      >
        <h2 className="text-center text-3xl font-bold text-[#4b3f28]">
          Featured Projects
        </h2>

        <p className="text-[#333333] max-w-3xl mx-auto mt-4 text-sm mb-16 text-center mediumText leading-relaxed">
          Explore our portfolio of successful digital design projects that have helped businesses transform their online presence and achieve measurable results.
        </p>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 bg-black/50 w-full text-white p-3">
                ...
                <h3 className="boldText text-2xl">{project.type}</h3>
                ...
                {selectedProject.images.map((_, idx) => (
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-all duration-300 ${
                      idx === currentIndex ? "bg-[#4b3f28] scale-125" : "bg-gray-300 hover:bg-gray-400"
                    }`}
